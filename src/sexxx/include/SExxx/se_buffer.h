...
#ifndef SEXXX_SE_BUFFER_H_
#define SEXXX_SE_BUFFER_H_
...
{
public:
  SEBuffer() : total_length_(0), end_of_first_message_(0)
  {
  }
  ...
  char* getNextBuffer()
  {
    ...
    char* start_of_message = (char*)memchr(buffer_, SE_STX, total_length_);
    ...
    end_of_first_message_ = (char*)memchr(buffer_, SE_ETX, total_length_);
...
private:
  ...
  char buffer_[SE_BUFFER_SIZE];
  uint16_t total_length_;

  char* end_of_first_message_;
};

#endif  // SEXXX_SE_BUFFER_H_

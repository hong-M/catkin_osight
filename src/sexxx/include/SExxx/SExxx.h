...
#include <SExxx/se_buffer.h>
#include <SExxx/se_structs.h>
#include <string>
#include <stdint.h>
...
/*!
* @class SExxx
* @brief Class responsible for communicating with SExxx device.
*
*/
...
public:
  ...
  INT32 UnpackUserParaSyncRsp(BITS8 *vpucMsg, USER_PARA_SYNC_RSP_T *vpstUserParaSyncRsp);

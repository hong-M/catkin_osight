...
#ifndef IEXXX_IE_BUFFER_H_
#define IEXXX_IE_BUFFER_H_
...
{
public:
  IEBuffer() : total_length_(0), end_of_first_message_(0)
  {
  }
  ...
  char* getNextBuffer()
  {
    ...
    char* start_of_message = (char*)memchr(buffer_, IE_STX, total_length_);
    ...
    end_of_first_message_ = (char*)memchr(buffer_, IE_ETX, total_length_);
...
private:
  ...
  char buffer_[IE_BUFFER_SIZE];
  uint16_t total_length_;

  char* end_of_first_message_;
};

#endif  // IEXXX_IE_BUFFER_H_
